...
import { getDoc, setDoc, doc, collection, query, where, getDocs, limit, deleteDoc, serverTimestamp } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js";
...
async function saveMemorial(e, memorialId, appRoot) {
    ...
    try {
        ...
        if (!memorialId) {
            memorialData.tierSortOrder = 4; // Or logic based on tier
...
async function initializePage(appRoot, urlParams) {
    ...
    if (typeof bootstrap !== 'undefined' && linkModalEl) {
